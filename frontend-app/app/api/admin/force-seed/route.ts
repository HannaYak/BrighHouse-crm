...
export async function GET() {
  try {
    const cleanersData = [
      ...
      { name: 'Анна К', telegramHandle: '@annkks', phone: 'metro kondratowicza', district: 'metro kondratowicza', tags: ['стандарт', 'генеральная'] },
      { name: 'Вика', telegramHandle: '@kkkwkwpw', phone: 'kaspszaka 29', district: 'kaspszaka 29', tags: ['стандарт', 'только_поддерживающая'] },
      { name: 'Таня', telegramHandle: '@ryzhaja_risovalshchica', phone: 'Arkadia, okopowa', district: 'Arkadia, okopowa', tags: ['стандарт', 'генеральная', 'без_стремянки'] },
      ...
      { name: 'Юлия', telegramHandle: null, phone: '+375295720840', district: 'metro stare bielany', tags: ['стандарт', 'генеральная', 'после_ремонта'] },
      ...
      { name: 'Химчистка основа', telegramHandle: '@RabbitInHole', phone: 'metro Zaczisze', district: 'metro Zaczisze', tags: ['химчистка', 'диваны', 'ковры'] },
